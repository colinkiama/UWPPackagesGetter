...
Note: This used restricted capabilites so only Business accounts can upload apps using this Component to the Store. However, anyone can still use this if they are sideloading the app.
